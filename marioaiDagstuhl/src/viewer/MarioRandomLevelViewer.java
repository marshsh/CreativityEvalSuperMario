...
public class MarioRandomLevelViewer {
	...
	// Mariana
	public static final String FILENAME = "VariablesLatentesGeeradas.txt";
	...
	public static void main(String[] args) throws IOException {
		...
		try {
			...
			bw.write(" Estas son las variables latentes (vectores de 32 valores Float) con las que se generaron los niveles encontrados en la carpeta ./randomSamples/ \n \n \n ");
		}catch (IOException e) {
			e.printStackTrace();
		} finally {
			try {
...
//			saveLevel(level, "randomSamples" + File.separator + filenameHead + "LevelCortado_" + i, true);
			saveLevel(level, "NivelesAleatorios2" + File.separator + filenameHead+ "Nivel_" + i, true);
			...
			try {
				...
				bw.write( "\n" );
				bw.write(Arrays.toString(variableLatente));
				bw.write( "\n \n" );
			}catch (IOException e) {
				e.printStackTrace();
			} finally {
